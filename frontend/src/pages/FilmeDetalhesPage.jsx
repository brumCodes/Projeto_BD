...
                : { nome_usuario: usuario.nome, url_avatar: usuario.url_avatar };
...
    if (!usuario) {
      alert("Você precisa estar logado para curtir um filme.");
      return;
    }
    try {
      await axios.post(`http://127.0.0.1:5000/api/reviews/like`, { 
        id_filme: review.id_filme,
        id_usuario_avaliacao: review.id_usuario,
        usuario_id_curtindo: usuario.id
      });
      
      // O estado local é atualizado corretamente
      setReviews(prevReviews => prevReviews.map(r => {
        // A curtida agora só afeta a review do próprio usuário
        if (r.id_usuario === usuario.id) {
          return { 
            ...r, 
            curtido_por_voce: !r.curtido_por_voce
          };
        }
        return r;
      }));
...
                  <Rating
                    name="user-rating"
                    value={myRating} // Alterado para myRating, a nota salva do usuário
...
                                    <img
                                        src={review.url_avatar || 'https://i.pinimg.com/736x/ea/4e/d2/ea4ed222812d5a178c49fc1cdc229016.jpg'} 
